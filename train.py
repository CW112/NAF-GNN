...
import os
# 【关键修复】强行指定使用 0 号显卡，覆盖 NNI 的屏蔽设置
...
parser.add_argument('--data', type=str, default='exchange_rate/exchange_rate.txt',
                    help='location of the data file')
parser.add_argument('--model', type=str, default='AP',
                    help='location of the data file')
...
parser.add_argument('--subgraph_size',type=int,default=7,help='k')
...
# ✅ 正确写法：动态检测
# 加了上面的 os.environ 后，这里的 is_available() 就会变回 True
device = torch.device("cuda")

print(f"当前代码使用的设备: {device}") # 应该打印 cuda
...
def main(params):
    ...
    model = magnn(args.gcn_depth, args.num_nodes,
                  ...
                  single_step=True,model = args.model)
...
if __name__ == "__main__":
    ...
    args = parser.parse_args(args=[
        '--save', './model-traffic3_NAF_GNN.pt',
        '--data', 'traffic.txt',
        '--model', 'AP_SAAG',
        '--num_nodes', '862',
        '--batch_size', '4',
